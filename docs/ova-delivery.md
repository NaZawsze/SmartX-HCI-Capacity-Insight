...
```text
smartx-capacity-insight-upgrade-v0.5.2.tar.gz
smartx-capacity-insight-upgrade-v0.5.2.tar.gz.sha256
```
...
smartx-upgrade-runner-v0.3.1.tar.gz.sha256
```
...
- OVA 文件名必须带平台版本，例如 `smartx-capacity-insight-v0.5.2.ova`。
...
```bash
sha256sum smartx-capacity-insight-v0.5.2.ova > smartx-capacity-insight-v0.5.2.ova.sha256
sha256sum smartx-capacity-insight-upgrade-v0.5.2.tar.gz > smartx-capacity-insight-upgrade-v0.5.2.tar.gz.sha256
```

用户下载后校验：

```bash
sha256sum -c smartx-capacity-insight-v0.5.2.ova.sha256
sha256sum -c smartx-capacity-insight-upgrade-v0.5.2.tar.gz.sha256
```
