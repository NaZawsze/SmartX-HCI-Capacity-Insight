...
|-------|------|----------|-------------|
| `AND` | ReplicationFailbackTargetExecutionWhereInput[] | No |  |
| `NOT` | ReplicationFailbackTargetExecutionWhereInput[] | No |  |
| `OR` | ReplicationFailbackTargetExecutionWhereInput[] | No |  |
| `failback_execution` | any | No |  |
