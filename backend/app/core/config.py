...
DEFAULT_APP_VERSION = "v0.5.2"
DEFAULT_RUNNER_VERSION = "v0.3.1"
...
class Settings(BaseSettings):
    ...
    project_path: Path = Field(default=Path("/data/smartx-storage-forecast/project"), alias="SMARTX_PROJECT_PATH")
