...
with open("remote_global2.css", "r") as f:
    css = f.read()
...
# 7. Update cluster-select background which is also hardcoded to rgba(255, 255, 255, 0.03)
css = re.sub(
...
with open("remote_global2.css", "w") as f:
    f.write(css)
